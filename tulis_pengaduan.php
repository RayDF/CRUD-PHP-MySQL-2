    ...
    <div class="card-body">
        <form action="simpan_pengaduan.php" method="post" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="form-group cols-sm-6">
                ...
                <input type="text" name="jam" class="form-control" value="<?php
            ...
            <div class="form-group cols-sm-6">
                ...
                <input type="number" name="suhu" placeholder="Masukkan Suhu Tubuh (Celcius)" class="form-control" min="34" max="40">
            </div>
            ...
            <div class="form-group cols-sm-6">
                <input type="submit" value="Simpan" class="btn btn-success" id="btn_simpan" onclick="alert('maaf anda dalam kondisi tidak sehat, anda tidak dapat berpergian sekarang silahkan karantina mandiri dirumah. Terima Kasih')">

...
<head>
  ...
  <style>
    ...
    #daftarButton:hover { 
      background-color: rgb(74, 27, 157);
      border: 1px solid rgb(74, 27, 157); 
    }
  </style>
</head>

<body class="bg-gradient-black" style="background-image: url(img/gedung.jpg);
                ...
                <div class="p-4">
                  ...
                  <form class="user" method="post" action="simpan_masyarakat.php">
                    <div class="form-group">
                      <input type="number" class="form-control form-control-user" name="nim" placeholder="Masukkan NIM" id="exampleinputEmail" aria-describedby="emailHelp"
